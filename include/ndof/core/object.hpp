...
struct mismatch_state {
    ...
    // TODO: Create this as a json string, constrained by a schema documented in the project.
    //       All error formats should follow the format that will be generated by the error library.
    //       Because of circular dependencies, files in core do not use the types defined in the error library directly.
    // TODO: Defining the error interface in core.
